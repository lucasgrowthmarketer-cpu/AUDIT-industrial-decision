      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-[#4a5568] text-sm leading-relaxed">
          ...
          <section>
            ...
            <Link to="/legal/privacy" className="text-[#207bff] underline">{lang === 'fr' ? 'Politique de Confidentialité' : 'Privacy Policy'}</Link>.</p>
          </section>
          <section>
    ...
    <div className="animate-fade-in py-20 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 pt-8 border-t border-[#e2e8f0]">
          <Link to="/legal" className="text-sm text-[#207bff] flex items-center gap-1 hover:gap-2 transition-all">
