...
import { ArrowRight, ArrowUpRight, FileText, BarChart3, Database, Globe, Calendar, Clock, ExternalLink, BookOpen, TrendingUp, Users, MapPin, Search, Shield, Zap, Factory, ChevronRight, Eye, Target } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-3 gap-5 auto-rows-[minmax(180px,auto)]">
            ...
            <div className="md:col-span-1 md:row-span-3 rounded-2xl overflow-hidden relative group">
              ...
              <div className="relative h-full flex flex-col justify-end p-7">
                ...
                <Link href="/contact" className="inline-flex items-center gap-2 px-4 py-2 border border-white/20 rounded-lg text-xs font-medium text-white hover:bg-white hover:text-[#1a1a1a] transition-all self-start">
