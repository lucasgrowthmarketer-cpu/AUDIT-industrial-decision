        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 md:gap-16">
            ...
            <div className="space-y-5">
              ...
              <Link href="/expertise" className="inline-flex items-center gap-1.5 px-5 py-2.5 bg-[#f5f7fa] border border-[#e2e8f0] rounded-lg text-sm font-medium text-[#1a1a1a] hover:border-[#207bff]/30 hover:bg-[#f0f7ff] transition-all group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
            ...
            <div className="md:row-span-2 bg-[#1a1a1a] rounded-2xl overflow-hidden text-white flex flex-col">
              ...
              <div className="p-7 flex-1 flex flex-col">
                ...
                <Link href="/expertise/audit-drs" className="inline-flex items-center gap-2 px-4 py-2.5 border border-white/20 rounded-lg text-sm font-medium text-white hover:bg-white hover:text-[#1a1a1a] transition-all self-start">
            ...
            <div className="bg-[#f5f7fa] rounded-2xl p-7 border border-[#e2e8f0] flex flex-col justify-between hover:border-[#207bff]/20 hover:shadow-lg hover:shadow-[#207bff]/5 transition-all">
              ...
              <Link href="/expertise/site-decisionnel" className="mt-5 text-sm font-medium text-[#207bff] flex items-center gap-1 hover:gap-2 transition-all">
            ...
            <div className="md:col-span-2 bg-[#f0f7ff] rounded-2xl p-7 border border-[#207bff]/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              ...
              <Link href="/expertise/strategie-acquisition" className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#207bff] text-white text-sm font-semibold rounded-lg hover:bg-[#1a62cc] transition-all flex-shrink-0">
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="md:col-span-2 bg-[#f0f7ff] rounded-2xl p-7 border border-[#207bff]/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                ...
                <Link href="/expertise/accompagnement" className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#207bff] text-white text-sm font-semibold rounded-lg hover:bg-[#1a62cc] transition-all flex-shrink-0">
                  {L === 'fr' ? 'Découvrir' : 'Explore'} <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-br from-[#207bff] to-[#1a62cc]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/team" className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-white text-[#207bff] font-semibold rounded-lg hover:bg-[#f0f7ff] transition-colors">
              {L === 'fr' ? 'Découvrir l\'équipe' : 'Meet the team'} <ArrowRight size={16} />
            </Link>
            <Link href="/contact" className="inline-flex items-center justify-center gap-2 px-8 py-3.5 border-2 border-white/30 text-white font-semibold rounded-lg hover:bg-white/10 transition-colors">
