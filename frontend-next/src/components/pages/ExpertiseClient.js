...
export default function ExpertiseClient({ serviceId }) {
  const { i18n } = useTranslation();
  const L = i18n.language;
  // serviceId from props
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 md:gap-16">
            ...
            <div className="space-y-5">
              ...
              <Link href="/contact" className="inline-flex items-center gap-1.5 px-5 py-2.5 bg-[#207bff] text-white rounded-lg text-sm font-semibold hover:bg-[#1a62cc] transition-all group">
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="relative overflow-hidden rounded-2xl">
            ...
            <div className="absolute top-6 left-6">
              <Link href="/expertise" className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/90 backdrop-blur-sm rounded-full text-xs font-medium text-[#1a1a1a] hover:bg-white transition-all">
                ...
                return (
                  <div key={i} className="md:col-span-2 md:row-span-3 bg-[#1a1a1a] rounded-2xl p-8 text-white flex flex-col justify-between">
                    ...
                    <div className="mt-6 pt-5 border-t border-white/10">
                      <Link href="/contact" className="inline-flex items-center gap-2 px-4 py-2 border border-white/20 rounded-lg text-sm font-medium text-white hover:bg-white hover:text-[#1a1a1a] transition-all">
