    ...
    >
      ...
      {isActive && (
        <div className="absolute inset-0 flex flex-col justify-end p-8">
          ...
          <Link href={`/sectors/${sector.id}`} className="inline-flex items-center gap-2 px-4 py-2 bg-white text-[#1a1a1a] text-sm font-semibold rounded-lg hover:bg-[#f0f7ff] transition-all self-start">
...
/* ════════════════════════════════════════════
   MAIN EXPORT
   ════════════════════════════════════════════ */
export default function SectorsClient({ sectorId }) {
    ...
    <div className="animate-fade-in" data-testid="sectors-page">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            <div className="w-full md:w-1/2 text-center md:text-left">
              ...
              <Link href="/contact" className="inline-flex items-center gap-2 px-6 py-3 bg-[#207bff] text-white font-semibold rounded-lg hover:bg-[#1a62cc] transition-all">
      ...
      <section className="py-20 bg-gradient-to-br from-[#207bff] to-[#1a62cc]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href="/contact" className="inline-flex items-center gap-2 px-10 py-4 bg-white text-[#207bff] font-semibold rounded-lg hover:bg-[#f0f7ff] transition-colors text-lg">
    ...
    <div className="animate-fade-in">
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 md:gap-16">
            ...
            <div className="space-y-5">
              ...
              <Link href="/contact" className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#207bff] text-white rounded-lg text-sm font-semibold hover:bg-[#1a62cc] transition-all">
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-5">
              ...
              if (i === 0) {
                ...
                return (
                  <div key={i} className="md:col-span-2 md:row-span-2 bg-[#207bff] rounded-2xl p-8 text-white flex flex-col justify-between min-h-[280px]">
                    ...
                    <Link href="/contact" className="mt-6 inline-flex items-center gap-2 px-4 py-2 border border-white/20 rounded-lg text-sm font-medium text-white hover:bg-white hover:text-[#207bff] transition-all self-start">
            ...
            <div className="md:col-span-4 bg-[#f0f7ff] rounded-2xl p-7 border border-[#207bff]/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
              ...
              <Link href="/contact" className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#207bff] text-white text-sm font-semibold rounded-lg hover:bg-[#1a62cc] transition-all flex-shrink-0">
      ...
      <section className="py-20 bg-gradient-to-br from-[#207bff] to-[#1a62cc]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-[#207bff] font-semibold rounded-lg hover:bg-[#f0f7ff] transition-colors">
